...
public class TestLocateEvent {
    ...
    public void testLocateEvent() {
        ...
        onView(withId(R.id.titleEditText)).perform(typeText("This is a LOCATION test"), pressBack());
        onView(withId(R.id.commentsEditText)).perform(typeText("Everything OK"), pressBack());
