...
import org.ereuse.scanner.utils.ToastExpander;
    ...
    private Camera createCamera() {
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                ToastExpander.showFor(mContext, mContext.getString(R.string.dialog_autofocus_not_supported), 6000);
              //  Toast.makeText(mContext, , Toast.).show();
