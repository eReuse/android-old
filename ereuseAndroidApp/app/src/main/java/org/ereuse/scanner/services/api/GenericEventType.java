...
public class GenericEventType {
    ...
    public static final Map<String,String> GENERIC_EVENT_PATH_MAP = new LinkedHashMap<String,String>();
    static {
    ...
    public static final Map<String,String> GENERIC_EVENT_LABEL_MAP = new LinkedHashMap<String,String>();
    static {
